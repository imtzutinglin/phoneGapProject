...
<div is="content" role="main" class="ui-content">
    ...
        <h4>保健食品</h4>
        <img  src="images/222.png" style="width:500px; margin:0px 10px 0px 12px">
    </div>
    <div data-role="collapsible">
        <h4>日常用品</h4>
        <img  src="images/333.png" style="width:500px; margin:0px 10px 0px 12px">
    </div>
    <div data-role="collapsible">
        <h4>醫療器材</h4>
        <img  src="images/444.png" style="width:500px; margin:0px 10px 0px 12px">
    </div>
